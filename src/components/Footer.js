...
function Footer() {
    ...
    return (
        ...
        <div className='footer'>
            <a target='_blank' rel="noopener noreferrer" href='https://github.com/jonathanprill'>
            ...
            <a target='_blank' rel="noopener noreferrer" href='https://www.linkedin.com/in/jonathan-prill-49423672/'>
            ...
            <a href="mailto:jonathantprill@gmail.com" target="blank">
                <svg className='contact-icon' xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="42" height="42" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5l8-5v10zm-8-7L4 6h16l-8 5z"></path></svg>
            </a>
        </div>
    )
}
